...
class BitmapMaker:
    ...
    def __init__(self):
        ...
        player_explosion0 = (0x00, 0x04, 0x01, 0x13, 0x03, 0x07, 0xB3, 0x0F, 0x2F, 0x03, 0x2F, 0x49, 0x04, 0x03, 0x00, 0x01)
        player_explosion1 = (0x40, 0x08, 0x05, 0xA3, 0x0A, 0x03, 0x5B, 0x0F, 0x27, 0x27, 0x0B, 0x4B, 0x40, 0x84, 0x11, 0x48)
        ...
        saucer_explosion = (0x00, 0x22, 0x00, 0xA5, 0x40, 0x08, 0x98, 0x3D, 0xB6, 0x3C, 0x36, 0x1D, 0x10, 0x48, 0x62, 0xB6,
                    0x1D, 0x98, 0x08, 0x42, 0x90, 0x08, 0x00, 0x00)
        squiggle_0 = (0x44, 0xAA, 0x10)
        squiggle_1 = (0x88, 0x54, 0x22)
        squiggle_2 = (0x10, 0xAA, 0x44)
        squiggle_3 = (0x22, 0x54, 0x88)
        plunger_0 = (0x04, 0xFC, 0x04)
        plunger_1 = (0x10, 0xFC, 0x10)
        plunger_2 = (0x20, 0xFC, 0x20)
        plunger_3 = (0x80, 0xFC, 0x80)
        rolling_0 = (0x00, 0xFE, 0x00)
        rolling_1 = (0x24, 0xFE, 0x12)
        rolling_2 = (0x00, 0xFE, 0x00)
        rolling_3 = (0x48, 0xFE, 0x90)
