...
INVADER_START = lambda x: 1024 - INVADER_FIRST_START if x < 0 else 1024 - 4 * x
INVADER_STARTS_COMPUTED = 0x400 - 0x60, 0x400 - 0x50, 0x400 - 0x48, 0x400 - 0x48, 0x400 - 0x48, 0x400 - 0x40, 0x400 - 0x40, 0x400 - 0x40
